//
// _4H_Application.Views.Pages.Records.ActivityRecordEditPage.xaml.cs: Page
//   that serves as a view for the user to edit a single activity record.
//
// Author(s):
...
namespace _4H_Application.Views.Pages.Records {
    ...
    /// <summary>
    /// Pages that serves to edit a single activity record.
    /// </summary>
	[XamlCompilation(XamlCompilationOptions.Compile)]
	public partial class ActivityRecordEditPage : ContentPage {

        /// <summary>
        /// Reference to the current entry on the page.
        /// </summary>
        private ActivityRecordEntry Entry;
        ...
        /// </summary>
		public ActivityRecordEditPage(ActivityRecordEntry entry) {
        ...
        private async void SaveButton_Clicked(object sender, 
            ...
            this.Entry.Location = this.LocationEditor.Text;
            await AppDatabase.GetInstance().Save
                <ActivityRecordEntry>(this.Entry);
        ...
        private void DeleteButton_Clicked(object sender,
            ...
            Device.BeginInvokeOnMainThread(async () => {
                ...
                await AppDatabase.GetInstance().Delete<ActivityRecordEntry>(this.Entry);
                await Navigation.PopAsync(true);
