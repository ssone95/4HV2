//
// _4H_Application.Views.Pages.Records.LaborRecordEditPage.xaml.cs: Page
//   that serves as a view for the user to edit a single labor record.
//
// Author(s):
...
namespace _4H_Application.Views.Pages.Records {
    ...
    /// <summary>
    /// Page that serves to edit a single labor record.
    /// </summary>
	[XamlCompilation(XamlCompilationOptions.Compile)]
    public partial class LaborRecordEditPage : ContentPage {

        /// <summary>
        /// Reference to the current entry on the page.
        /// </summary>
        private LaborRecordEntry Entry;
        ...
        private void DeleteButton_Clicked(object sender,
            ...
            Device.BeginInvokeOnMainThread(async () => {
                ...
                await AppDatabase.GetInstance().Delete<LaborRecordEntry>(this.Entry);
                await Navigation.PopAsync(true);
