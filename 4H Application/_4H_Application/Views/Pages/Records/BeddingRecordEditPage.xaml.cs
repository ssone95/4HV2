//
// _4H_Application.Views.Pages.Records.BeddingRecordEditPage.xaml.cs: Page that
//   serves as a view for the user to edit a single bedding record.
//
// Author(s):
...
namespace _4H_Application.Views.Pages.Records {
    ...
    /// <summary>
    /// Page that allows for editing of a single bedding record.
    /// </summary>
    [XamlCompilation(XamlCompilationOptions.Compile)]
    public partial class BeddingRecordEditPage : ContentPage {

        /// <summary>
        /// Reference to the current entry on the page.
        /// </summary>
        private BeddingRecordEntry Entry;
        ...
        private void DeleteButton_Clicked(object sender,
            ...
            Device.BeginInvokeOnMainThread(async () => {
                ...
                await AppDatabase.GetInstance().Delete<BeddingRecordEntry>(this.Entry);
                await Navigation.PopAsync(true);
